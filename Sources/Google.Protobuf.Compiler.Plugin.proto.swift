...
public extension Google.Protobuf.Compiler {
    ...
    final public class Version : GeneratedMessage {
        ...
        override class public func fromJSON(data:Data, options: JSONSerialization.ReadingOptions = []) throws -> Google.Protobuf.Compiler.Version {
            return try Google.Protobuf.Compiler.Version.Builder.fromJSONToBuilder(data:data, options:options).build()
        }
        override public func getDescription(indent:String) throws -> String {
            var output = ""
            if hasMajor {
                output += "\(indent) major: \(String(describing: major)) \n"
            }
            if hasMinor {
                output += "\(indent) minor: \(String(describing: minor)) \n"
            }
            if hasPatch {
                output += "\(indent) patch: \(String(describing: patch)) \n"
            }
            if hasSuffix {
                output += "\(indent) suffix: \(String(describing: suffix)) \n"
            }
        ...
        final public class Builder : GeneratedMessageBuilder {
            ...
            override class public func fromJSONToBuilder(data:Data, options: JSONSerialization.ReadingOptions = []) throws -> Google.Protobuf.Compiler.Version.Builder {
    ...
    final public class CodeGeneratorRequest : GeneratedMessage {
        ...
        override public func isInitialized() throws {
            for oneElementProtoFile in protoFile {
                try oneElementProtoFile.isInitialized()
            }
        }
        override public func writeTo(codedOutputStream: CodedOutputStream) throws {
        ...
        override class public func fromJSON(data:Data, options: JSONSerialization.ReadingOptions = []) throws -> Google.Protobuf.Compiler.CodeGeneratorRequest {
            return try Google.Protobuf.Compiler.CodeGeneratorRequest.Builder.fromJSONToBuilder(data:data, options:options).build()
        }
        override public func getDescription(indent:String) throws -> String {
            var output = ""
            ...
            if hasParameter {
                output += "\(indent) parameter: \(String(describing: parameter)) \n"
            }
            if hasCompilerVersion {
        ...
        final public class Builder : GeneratedMessageBuilder {
            ...
            override class public func fromJSONToBuilder(data:Data, options: JSONSerialization.ReadingOptions = []) throws -> Google.Protobuf.Compiler.CodeGeneratorRequest.Builder {
                let jsonData = try JSONSerialization.jsonObject(with:data, options: options)
                guard let jsDataCast = jsonData as? Dictionary<String,Any> else {
                  throw ProtocolBuffersError.invalidProtocolBuffer("Invalid JSON data")
                }
    ...
    final public class CodeGeneratorResponse : GeneratedMessage {
        ...
        final public class File : GeneratedMessage {
            ...
            override class public func fromJSON(data:Data, options: JSONSerialization.ReadingOptions = []) throws -> Google.Protobuf.Compiler.CodeGeneratorResponse.File {
                return try Google.Protobuf.Compiler.CodeGeneratorResponse.File.Builder.fromJSONToBuilder(data:data, options:options).build()
            }
            override public func getDescription(indent:String) throws -> String {
                var output = ""
                if hasName {
                ...
                if hasInsertionPoint {
                    output += "\(indent) insertionPoint: \(String(describing: insertionPoint)) \n"
                }
                if hasContent {
                    output += "\(indent) content: \(String(describing: content)) \n"
                }
                output += unknownFields.getDescription(indent: indent)
                return output
            }
            ...
            final public class Builder : GeneratedMessageBuilder {
                ...
                override class public func fromJSONToBuilder(data:Data, options: JSONSerialization.ReadingOptions = []) throws -> Google.Protobuf.Compiler.CodeGeneratorResponse.File.Builder {
                    let jsonData = try JSONSerialization.jsonObject(with:data, options: options)
                    guard let jsDataCast = jsonData as? Dictionary<String,Any> else {
                      throw ProtocolBuffersError.invalidProtocolBuffer("Invalid JSON data")
                    }
        ...
        override class public func fromJSON(data:Data, options: JSONSerialization.ReadingOptions = []) throws -> Google.Protobuf.Compiler.CodeGeneratorResponse {
            return try Google.Protobuf.Compiler.CodeGeneratorResponse.Builder.fromJSONToBuilder(data:data, options:options).build()
        }
        override public func getDescription(indent:String) throws -> String {
            var output = ""
            if hasError {
                output += "\(indent) error: \(String(describing: error)) \n"
            }
        ...
        final public class Builder : GeneratedMessageBuilder {
            ...
            override class public func fromJSONToBuilder(data:Data, options: JSONSerialization.ReadingOptions = []) throws -> Google.Protobuf.Compiler.CodeGeneratorResponse.Builder {
                let jsonData = try JSONSerialization.jsonObject(with:data, options: options)
                guard let jsDataCast = jsonData as? Dictionary<String,Any> else {
                  throw ProtocolBuffersError.invalidProtocolBuffer("Invalid JSON data")
                }
